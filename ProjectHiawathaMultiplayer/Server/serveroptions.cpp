    ...
    ui(new Ui::ServerOptions)
{
    ...
    OptionsStyle += "QListView { border: 2px inset #f6b300; show-decoration-selected: 1; } QLabel#leaderPortrait, #humanCountLabel, #aiCountLabel { border: 2px inset #f6b300; background: #dedede; max-height: 200px; max-width: 210px; }";
